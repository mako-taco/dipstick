...
export const foundModuleToProcessedDependencies = (module: FoundModule, project: Project): ProcessedDependency[] => {
  return module.dependencies?.getElements().map((element) => {
