export declare namespace dip {
    type GetBindings<Structure extends ModuleStructure<Module[], Module>> = Structure['bindings'];
    type BindingFn<T> = () => T;
    /**
     ...
     * ```
     */
    export type Module<Structure extends ModuleStructure<any[], any> = ModuleStructure<any[], any>> = {
     ...
     */
    export type ModuleStructure<Dependencies extends Module[], Bindings extends Record<string, Bind.Reusable<unknown> | Bind.Transient<unknown> | Bind.Static<unknown>> = {}> = {
    ...
    export namespace Bind {
         ...
         */
        type Transient<T extends B, B = T> = {
            __transient?: never;
        } & BindingFn<B>;
        /**
         * A binding that returns the same instance of `T` every time it is called. This is used
